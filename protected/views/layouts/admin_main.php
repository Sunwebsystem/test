		...
		<?php 
                ...
                if(isset(Yii::app()->user->id) and Yii::app()->user->id !=''){
                    /*$this->widget('zii.widgets.CMenu',array(
                        'items'=>array(
                                array('label'=>'Dashboard', 'url'=>array('users/admin_dashboard')),
                                array('label'=>'Manage User', 'url'=>array('users/admin_manageuser', 'view'=>'about')),
                                array('label'=>'Manage Group', 'url'=>array('groups/admin')),
            ...
            <div id="mainmenu">
		<ul id="yw0">
                    <li class=""><?php echo CHtml::link('Dashboard',Yii::app()->request->baseUrl.'/index.php/users/admin_dashboard')?></li>
                    <li><?php echo CHtml::link('Manage User',Yii::app()->request->baseUrl.'/index.php/users/admin')?></li>
                    <li><?php echo CHtml::link('Manage Group',Yii::app()->request->baseUrl.'/index.php/groups/admin')?></li>
